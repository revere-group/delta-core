package dev.revere.revsentials.feature.combat;

import dev.revere.revsentials.Revsential;
import dev.revere.revsentials.api.service.Service;
import dev.revere.revsentials.feature.combat.listener.CombatLogListener;
 ...
 */
@Getter
public class CombatLogService implements Service {
     ...
     */
    public CombatLogService(Revsential plugin) {
        this.plugin = plugin;
    }
