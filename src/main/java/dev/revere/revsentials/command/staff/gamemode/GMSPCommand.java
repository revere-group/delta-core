package dev.revere.revsentials.command.staff.gamemode;
...
public class GMSPCommand extends BaseCommand {
    @Command(name = "gmsp", aliases = {"gm.sp", "spectator", "gamemode.sp", "gamemode.3", "gamemode.spectator", "gm.3", "gm3", "gm.spectator"}, permission = "revsentials.staff.gamemode.spectator", description = "Change your gamemode to spectator", usage = "/gmsp [player]")
    @Override
