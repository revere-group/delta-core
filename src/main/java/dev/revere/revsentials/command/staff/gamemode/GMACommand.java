...
public class GMACommand extends BaseCommand {
    @Command(name = "gma", aliases = {"gm.a", "adventure", "gamemode.a", "gamemode.2", "gamemode.adventure", "gm.2", "gm2", "gm.adventure"}, permission = "revsentials.staff.gamemode.adventure", description = "Change your gamemode to adventure", usage = "/gma [player]")
    @Override
