...
public class GMCCommand extends BaseCommand {
    @Command(name = "gmc", aliases = {"gm.c", "creative", "gamemode.c", "gamemode.1", "gamemode.creative", "gm.1", "gm1", "gm.creative"}, permission = "revsentials.staff.gamemode.creative", description = "Change your gamemode to creative", usage = "/gmc [player]")
    @Override
