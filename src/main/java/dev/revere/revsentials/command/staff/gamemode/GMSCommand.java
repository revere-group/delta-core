...
public class GMSCommand extends BaseCommand {
    @Command(name = "gms", aliases = {"gm.s", "survival", "gamemode.s", "gamemode.0", "gamemode.survival", "gm.0", "gm0", "gm.survival"}, permission = "revsentials.staff.gamemode.survival", description = "Change your gamemode to survival", usage = "/gms [player]")
    @Override
