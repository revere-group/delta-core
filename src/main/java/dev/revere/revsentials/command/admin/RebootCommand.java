...
public class RebootCommand extends BaseCommand {
    ...
    @Command(name = "reboot", permission = "revsentials.admin.reboot", description = "Reboots the server", usage = "/reboot <time> | <cancel>")
    @Override
    ...
    private void startCountdown(int time) {
        ...
        countdownTask.runTaskTimer(Revsential.getInstance(), 0L, 20L);
    }
