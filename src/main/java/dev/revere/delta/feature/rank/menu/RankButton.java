...
public class RankButton extends Button {
    ...
    public ItemStack getButtonItem(Player player) {
        return new ItemBuilder(Material.WHITE_WOOL)
                ...
                .lore(" &f● &bStaff: &7" + (rank.isStaffRank() ? "Yes" : "No"))
                .lore(" &f● &bDefault: &7" + (rank.isDefaultRank() ? "Yes" : "No"))
                .lore(" &f● &bPurchasable: &7" + (rank.isPurchasable() ? "Yes" : "No"))
                .lore(" &f● &bGlobal: &7" + (rank.isGlobal() ? "Yes" : "No"))
                .lore(" &f● &bHidden: &7" + (rank.isHidden() ? "Yes" : "No"))
                .lore(" &f● &bInheritance: &7" + rank.getInheritance().size())
                .lore(" &f● &bPermissions: &7" + rank.getPermissions().size())
                .lore(" &f● &bServers: &7" + rank.getServers().size())
                .lore("")
                .lore("&b&lActions:")
