package dev.revere.delta.util.menu;
...
public abstract class Menu {
    ...
    @Getter
    protected Delta ricardo = Delta.getInstance();
    ...
    public void addBorder(Map<Integer, Button> buttons, byte data, int rows) {
        ...
        for (int i = 0; i < 9; i++) {
            buttons.putIfAbsent((rows - 1) * 9 + i, Button.placeholder(Material.BLACK_STAINED_GLASS_PANE, data, ""));
        }
